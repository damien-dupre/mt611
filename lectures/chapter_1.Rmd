...
- $H_a$: **Driving errors** of **motorists who do not talk on the phone while driving** will be *lower* than **driving errors** of **motorists who do not talk on the phone while driving**
...
In the research paper that you have selected:

- If you can identify already formulated hypotheses, reformulate them using the templates presented earlier in these slides

- If you can't identify already formulated hypotheses, formulate them using the role of variables that you have previously determined
...
Remember, there is only 1 Outcome variable per model and it is not possible to draw two model with the same Outcome variable.
...
- The Outcome can be described by a statistical model, which expresses what we expect to occur in the Outcome according to each Predictor.
- The remaining part of the Outcome's variability that is not explained by the model is call the Error.
...
**In the research paper you have selected, write the equation corresponding to the model(s)**
