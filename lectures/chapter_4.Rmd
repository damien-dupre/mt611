...
$Perceived\,Usefulness = \alpha_1.PU1 + \alpha_2.PU2 + \alpha_3.PU3 + \alpha_4.PU4 + \alpha_5.PU5 + \epsilon$
$Perceived\,Ease\,of\,use = \alpha_1.PEOU1 + \alpha_2.PEOU2 + \alpha_3.PEOU3 + \alpha_4.PEOU4 + \epsilon$
$Intention\,to\,Use = \alpha_1.BI1 + \alpha_2.BI2 + \epsilon$

**A Linear Regression is performed for each outcome variable**

Example:

$Perceived\,Usefulness = \beta_0 + \beta_1.Perceived\,Ease\,of\,use + \epsilon$
$Intention\,to\,Use = \beta_0 + \beta_1.Perceived\,Usefulness + \beta_2.Perceived\,Ease\,of\,use + \epsilon$
$Actual\,Use = \beta_0 + \beta_1.Intention\,to\,Use + \epsilon$
...
.pull-right[
```{r out.width='100%'}
knitr::include_graphics("https://lavaan.ugent.be/tutorial/figure/sem.png")
```
]
