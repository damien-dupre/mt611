...
- "the variable X influences the variable X"
...
We can distinguish 2 types of model:
...
The relation between two variables and another
...
Note: 
- interaction means that the effect of X on Y will be different according the possibilities of Z (see section about hypothesis formulation)
...
1. Each model corresponds to 1 equation

2. Each model has only one Outcome/Dependent Variable

3. Control variables are not included in models

If 1. or 2. are not possible then more than one model needs to be used or a path analyses can also be performed
...
Warning, a mediation hypothesis involves two main hypotheses: IV1 on DV and IV1 on IV2/Med
