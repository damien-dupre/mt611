...
**The deadline is June 21st, 2024.**
...
```{r out.width='50%'}
knitr::include_graphics("https://i.pinimg.com/originals/d5/fd/e4/d5fde43f1d5389f3b586fdb7b100d59d.jpg")
```
...
```{r out.width='30%'}
knitr::include_img("jamovi_icons.png")
```
...
```{r out.width = "50%"}
knitr::include_img("ex1_title.png")
```

```{r out.width = "50%"}
knitr::include_img("ex1_hyp.png")
```
...
```{r out.width = "50%"}
knitr::include_img("ex2_title.png")
```

```{r out.width = "50%"}
knitr::include_img("ex2_hyp1.png")
```

```{r out.width = "50%"}
knitr::include_img("ex2_hyp2.png")
```
