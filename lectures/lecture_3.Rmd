...
Latin alphabet (e.g. $b$) is used for parameters that are non-standardized (i.e., expressed in the unit of the predictor such as years for age or euro for salary).

Greek alphabet (e.g. $\beta$) is used when parameters are standardized (i.e., expressed in term of correlation ranging from 1 to -1). Because it is possible to compare standardized parameters, Greek alphabet are generally preferred.
