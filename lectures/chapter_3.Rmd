...
By default, Categorical variables **are recoded using the alphabetical order** (e.g., here Female first then Male) using 1, 2, 3 and so on.
...
```{r out.width = "100%"}
include_graphics("img/jamovi_lm_main_c2.png")
```
