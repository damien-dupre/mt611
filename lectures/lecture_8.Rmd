...
The Quarto team has developed several Journal formats and made them available within the [quarto-journals GitHub organization](https://github.com/quarto-journals/). These formats include:
...
2/ Render the default document obtained to observe its structure
...
This research paper should nclude:
