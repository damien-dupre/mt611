...
2/ Then, go to `Account`, then `Tokens` on the top menu and copy your **Token** and **Secret Token**

3/ In the Terminal window, run the following instructions:

```markdown
quarto publish posit-cloud mysite
```

4/ Fill the **Token** and the **Secret Token**, and finally go to the URL provided (e.g., https://posit.cloud/content/7853011)
...
2/ In the Terminal window, run the following instructions:

```markdown
quarto preview mysite
```

Note: you need to install quarto on your desktop first from here: https://quarto.org/
]
