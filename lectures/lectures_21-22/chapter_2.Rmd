...
```{r out.width = "100%"}
knitr::include_img("clean_tweet.png")
```
...
```{r out.width = "100%"}
knitr::include_img("clean_zoom.jpg")
```
...
```{r out.width = "100%"}
knitr::include_img("clean_answer.png")
```
...
```{r out.width = "70%"}
knitr::include_img("name_convention.jpg")
```
...
.pull-right[
```{r out.width = "70%"}
knitr::include_img("key_movements.png")
```
]
...
```{r out.width = "50%"}
knitr::include_img("extension_img.png")
```
...
```{r out.width = "50%"}
knitr::include_img("reduction_img.png")
```
...
```{r out.width = "40%"}
knitr::include_img("direction_img.png")
```
...
```{r out.width = "50%"}
knitr::include_img("aggregation_img.png")
```
...
```{r out.width = "50%"}
knitr::include_img("combination_img.png")
```
...
```{r out.width = "100%"}
knitr::include_img("tidy_full.png")
```
...
```{r out.width = "80%"}
knitr::include_img("long_table.png")
```

## Wide Format

```{r out.width = "80%"}
knitr::include_img("wide_table.png")
```
...
```{r out.width = "100%"}
knitr::include_img("long_or_wide.png")
```

--

```{r out.width = "100%"}
knitr::include_img("long_and_wide.png")
```
...
```{r out.width = "50%"}
knitr::include_img("reshape_excel.gif")
```
